...
//         document.getElementById('loader').style.display = 'Block';
  ...
  appStart.$inject = ['$rootScope','$state','$cookies','$timeout' ,'searchService','$location','gettextCatalog'];
  /* @ngInject */
  function appStart( $rootScope,$state,$cookies ,$timeout ,searchService,$location,gettextCatalog) {  
